...
public class BuyerController {
	...
	//Login buyer
		...
		@GetMapping(value = "/api/buyer/amountrp/{buyerId}",produces = MediaType.APPLICATION_JSON_VALUE)
		...
		//Check priviliged buyer
		@GetMapping(value = "/api/buyerIsPrivileged/{buyerId}",  produces = MediaType.APPLICATION_JSON_VALUE)
